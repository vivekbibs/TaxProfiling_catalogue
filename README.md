...
Taxonomic profiling refers to methods that produce relative abundance of present microorganisms, through an abundance profile table, without any binning/assembly methods.
